...
- ควรเห็น: `{"status": "healthy", "bot": {"ready": true, "connected": true}}`

### ขั้นตอนที่ 6: ตั้ง Keep-Alive (สำคัญมาก! 🚨)

**ปัญหา:** Render Free Tier จะ spin down หลังไม่มีการใช้งาน 15 นาที
...
### ปัญหา: Bot Offline หลัง Deploy

**วิธีแก้:**
1. ตรวจสอบ logs ใน Render Dashboard
2. ดูที่ **Logs** tab และหา error
3. ตรวจสอบว่ามี message: `✅ Discord bot started` และ `✅ Bot is ready!`
4. ถ้าไม่มี → ตรวจสอบ `DISCORD_TOKEN` ใน Environment Variables

### ปัญหา: Bot ออนไลน์แล้ว Offline สักพัก

**สาเหตุ:** Render Free Tier spin down หลัง 15 นาที

**วิธีแก้:**
1. ตั้ง UptimeRobot (ดูข้างบน) - แนะนำที่สุด ⭐
2. หรือ upgrade เป็น Paid plan ($7/month)
